...
// Retrasar el pago de nomina (Cambio fecha pago nomina) (Customers - Whatsapp)
router.post('/delayPayrollPayment', validateToken, payrollPaymentController.delayPayrollPayment);
